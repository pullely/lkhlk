...
//   - `~/.config/lkhlk/credentials.json` (0600)
//   - `~/.config/lkhlk/config.json`     (0644)
//
// Override via `LKHLK_CONFIG_DIR` (used heavily by tests).
...
export function resolveConfigDir(): string {
  ...
  // the dir they expect; fall back to `~/.config/lkhlk` everywhere
