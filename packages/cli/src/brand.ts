...
// `@saas/sdk` client class name (`newproj`) is intentionally NOT part of
...
export const CLI_BIN = "lkhlk";

/** Product/brand name used in human-facing CLI copy. */
export const PRODUCT_NAME = "new-proj";

/** Default API base URL when `--api-url` is not supplied. */
export const DEFAULT_API_URL = "https://api.asa.com";
