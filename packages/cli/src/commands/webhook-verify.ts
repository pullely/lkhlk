// `lkhlk webhook verify` — local cryptographic verification of a
// newproj outbound webhook delivery (Task 0106).
//
...
//     command is usable on a fresh install with no `lkhlk login`.
