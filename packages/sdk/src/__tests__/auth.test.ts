...
//   - newprojError hierarchy propagation with request-id passthrough
...
function client(fetchImpl: typeof fetch): newproj {
  return new newproj({ baseUrl: "https://api.test", fetch: fetchImpl });
}
...
describe("AuthClient", () => {
  ...
  it("client.auth is wired onto the newproj class", () => {
