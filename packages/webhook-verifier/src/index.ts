 ...
 * signature verifier for newproj outbound webhook deliveries.
 *
...
/**
 * Compute the canonical newproj webhook signature for a payload.
...
/**
 * Verify the HMAC-SHA256 signature of a newproj webhook delivery.
 *
